...
window.Vue = __webpack_require__(102);
...
Vue.component('checkout-form', __webpack_require__(103));
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3a26cfc1", Component.options)
  } else {
    hotAPI.reload("data-v-3a26cfc1", Component.options)
  }
    ...
    created: function created() {
        ...
        this.stripe = StripeCheckout.configure({
            ...
            token: function token(_token) {
                ...
                _this._token = document.querySelector('meta[name="csrf-token"]').content;
                _this.email = document.querySelector('input[name="email"]').value;
                _this.first_name = document.querySelector('input[name="first_name"]').value;
                _this.last_name = document.querySelector('input[name="last_name"]').value;
                _this.zip = document.querySelector('input[name="zipcode"]').value;
                _this.address = document.querySelector('input[name="address"]').value;

                var formData = _this.$data;

                console.log(formData);

                axios.post('/buy-ticket', formData).then(function (response) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "section center-container" }, [
  ...
  function() {
    ...
    return _c("div", { staticClass: "row" }, [
      ...
      _c("div", { staticClass: "form-group col-md-5" }, [
        _c("label", { attrs: { for: "zipcode" } }, [_vm._v("   ")]),
        _vm._v(" "),
        _c("input", {
          staticClass: "form-control",
          attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3a26cfc1", module.exports)
  }
}
